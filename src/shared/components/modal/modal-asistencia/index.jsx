...
export const ModalNuevaAsistencia = ({ modalVisible, setModalVisible, seccion, dataType, onValidationMessage }) => {
  ...
  const guardarInformacion = async () => {
    if(dataType === 'create') {
      if (!selectedSemana) {
        onValidationMessage('Debe seleccionar una semana'); // Llama a la función de callback
        return;
      }

      const todosSeleccionados = asistencia.every(estado => estado !== "");
      if (!todosSeleccionados) {
        onValidationMessage('Debe seleccionar la asistencia de todos los estudiantes'); // Llama a la función de callback
        return;
      }
